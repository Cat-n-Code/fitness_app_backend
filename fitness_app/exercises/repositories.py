...
class ExerciseRepository:
    ...
    async def get_by_user_id(
        ...
        if find_schema:
            if find_schema.name:
                statement = statement.where(Exercise.name == find_schema.name)
            if find_schema.muscle:
                statement = statement.where(Exercise.muscle == find_schema.muscle)
            if find_schema.additionalMuscle:
                statement = statement.where(
                    Exercise.additionalMuscle == find_schema.additionalMuscle
                )
            if find_schema.type:
                statement = statement.where(Exercise.type == find_schema.type)
            if find_schema.equipment:
                statement = statement.where(Exercise.equipment == find_schema.equipment)
            ...
            if find_schema.description:
                statement = statement.where(
                    Exercise.description == find_schema.description
                )
        statement = (
